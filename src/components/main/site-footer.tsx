    ...
    <footer aria-label="Footer" className="w-full">
      <div className="container grid w-full max-w-6xl gap-7 py-10">
        ...
        <p className="text-xs text-foreground/60 sm:text-sm">
          Made By Jaden | All Rights Reserved |  {new Date().getFullYear()} {siteConfig.author}
        </p>
      </div>
      ...
      <div className="container flex h-24 items-center gap-2 px-8">
        ...
        <p className="text-center text-xs leading-loose sm:text-sm md:text-left">
            This Website does not host any files, it only links to 3rd party services. Legal issues should be taken up with the file hosts and providers. We are not responsible for any media files shown by the video providers.
          <a
